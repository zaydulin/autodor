    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.PositiveSmallIntegerField(choices=[(0, 'Сотрудники'), (1, 'Клиент')], default=1, verbose_name='Тип пользователя')),
                ('on_hands', models.DecimalField(blank=True, decimal_places=2, max_digits=12, null=True, verbose_name='Стоимость доставки')),
                ('employee', models.PositiveSmallIntegerField(choices=[(0, 'Нет должности'), (1, 'Водитель'), (2, 'Менеджер'), (3, 'Посредник'), (4, 'Админ')], default=0, verbose_name='Должность')),
