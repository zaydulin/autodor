...
MIDDLEWARE = [
    ...
    'moderation.middleware.AdvertApplicationLogMiddleware',
...
YANDEX_DISK_TOKEN = 'y0__xDW_u-2CBj4tjogr8PyvRTJ_Pe5GDabgbnD2zC0ldkWvSubPw'
YANDEX_DISK_BASE_PATH = 'audio_backups'
