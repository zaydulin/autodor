...
urlpatterns = [
    path("statistics/", views.AdvertStatisticsView.as_view(), name="statistics"),
    ...
    path('application/<uuid:application_id>/update/', views.UpdateApplicationView.as_view(), name='update_application'),
    ...
    path('applications-list/', views.ApplicationListView.as_view(), name='application_list'),
